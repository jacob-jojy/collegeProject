                                            ...
                                            <tbody>
                                                ...
                                                <td>" . $row['user_created_at'] . "</td>";
                                                    if ($row['user_status'] == 1) {
                                                        echo ("
                                                    <td><form action='#' method='post'><button type='submit' class='btn btn-danger' name='delte' value=" . $row['user_id'] . ">Suspend</button></form></td></tr>
                                                    ");
                                                    } else {
                                                        echo ("
                                                        <td><form action='#' method='post'><button type='submit' class='btn btn-success' name='act' value=" . $row['user_id'] . ">Activate</button></form></td></tr>
                                                        ");
                                                    }
                                                }
                                                ?>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="#" name="registerForm" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="exampleInputEmail1" name="email" aria-describedby="emailHelp" onblur="validate_email()" placeholder="Enter email">
                                            <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Phone No</label>
                                            <input type="number" maxlength="10" class="form-control" id="exampleInputPassword1" name="number" onblur=" validate_mobile()" placeholder="number">
                                        </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="addNewUserSubmit" class="btn btn-primary">Save changes</button>
                                    </form>
                                </div>
                            </div>
                        </div>
