                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            ...
                            <form method="POST" action="./fileupload.php" enctype="multipart/form-data">
                                <label for="uploadFile" class="btn btn-primary w-25" name="updateProfileBtn">Upload</label>
                                <input type="file" name="uploadFile" id="uploadFile" style="display:none;" />
                                <button class="btn btn-primary w-25" id="uploadSubmit" name="uploadSubmit" type="submit">Submit</button>
                            </form>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <table id="datatablesSimple" class="dataTable-table">
                                    ...
                                    ?>
                                        <tr> <?php $idd = $row['id'] ?>
                                            ...
                                            <td><button type='submit' class='btn btn-success' name='delte'>View</button></td>
                                            <!-- <td><button type='submit' class='btn btn-danger' name='delte'>Delete</button></td> -->
                                            <?php
                                            $id = $row['id'];
                                            if ($row["status"] == 1) {

                                                echo "<td><form action='medicalreport.php' method='post'><button class='btn btn-danger' type='submit' value=" . $id . " name='del'>Delete</button></form></td>";
                                            } else {
                                                echo ("<td><form action='medicalreport.php' method='post'><button class='btn btn-success' type='submit' value=" . $id . " name='act'>Activate</button></form></td>");
                                            }
                                            ?>
                                            ...
                                            if (isset($_POST['del'])) {
                                                $id = $_POST['del'];
                                                $query = "UPDATE `medical_history` SET `status`=0 WHERE id='$id'";
                                            ...
                                            if (isset($_POST['act'])) {
                                                $id = $_POST['act'];
                                                $query = "UPDATE `medical_history` SET `status`=1 WHERE id='$id'";
                                                mysqli_query($connect, $query);
                                                echo ("
                                                  <script>
                                                  window.location.href=medicalreport.php';
