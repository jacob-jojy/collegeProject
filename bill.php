                            ...
                            <div class="form-group col-6">
                                ...
                                <select class="form-control" name='doctor'>
                                    ...
                                    while ($row = mysqli_fetch_array($fetchdoctorResult)) {
                                        echo '<option value=' . $row['doctor_name'] . ' -' . $row['specialization'] . '>' . $row['doctor_name'] . ' -' . $row['specialization'] . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>

                            <br> <input type="submit" value="Pay with Card" data-key="<?php echo $publishableKey ?>" data-amount="<?php echo $payAmount ?>" data-currency="inr" data-name="HELLO DOC" data-description="HELLO DOC Payment" />
