...
<body class="sb-nav-fixed">
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="#">Unregistered User</a></li>
                    ...
                    <div class="row">
                        <form action="#" method="post">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name='mobile' required placeholder="Enter mobile number" autocomplete="off">
                                <small id="emailHelp" class="form-text text-muted">We'll never share your number with anyone else.</small>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Enter Patient Name</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="reason" class="form-control" required placeholder="Enter reason">
                            </div>
                            <br>
                    </div>
    ...
    if (isset($_POST['emergency'])) {
        ...
        extract($_POST);
        $sql = "INSERT INTO `duty_doc`(`name`, `mobile`, `reason`) VALUES ('$pName','$mobile','$reason')";
