            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Hospital Dashboard</h1>
                        ...
                        <div class="row">
                            ...
                            <div class='card bg-primary text-white mb-4'>
                                <div class='card-body'>" . $fetchRow['hospital_name'] . "<i class='ml-2 fas fa-hospital fa-2x'><br></i></div>" . $fetchRow['specialities'] . "
                                <div class='card-footer d-flex align-items-center tip justify-content-between' title='Mobile No:" . $fetchRow['hospital_number'] . "&#013;Location :" . $fetchRow['hospital_location'] . "'>
                                   <form method='post' action='appointment.php'><button class='small text-dark stretched-link btn btn-info' type='submit' name='appointmentSubmit' value='" . $fetchRow['hospital_id'] . "'>View Details</a>
                                    </form>
